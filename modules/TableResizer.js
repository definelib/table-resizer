...
const Meta = require('./TableResizer/Meta');
const Template = require('./TableResizer/Template');
const Events = require('./TableResizer/Events');
const Column = require('./TableResizer/Column');
